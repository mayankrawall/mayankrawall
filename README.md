...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=20&pause=1000&color=2E9EF7&center=true&vCenter=true&width=650&lines=Building+scalable+cloud+infrastructure...;Automating+everything+with+DevOps...;Terraform+%7C+Ansible+%7C+Kubernetes+%7C+AWS;Turning+manual+ops+into+one-click+deploys..." alt="Typing SVG" />
</p>
...
With strong problem-solving abilities, I identify issues, develop solutions, and own the delivery and implementation end-to-end. I focus on building **scalable cloud infrastructure**, optimizing **CI/CD pipelines**, and implementing robust **DevOps practices** that drive real business outcomes.

```yaml
name: Mayank Rawal
role: Cloud Architect / DevOps Engineer
focus: [AWS, Terraform, Kubernetes, CI/CD Automation]
currently_working_on: Cloud-native infrastructure & automation projects
currently_learning: Advanced Kubernetes patterns, IaC best practices, Cloud Security
philosophy: "Automate everything. Document everything. Break nothing."
fun_fact: Turns manual runbooks into one-click pipelines
```
...
|---|---|
| ☁️ **Cloud & Architecture** | AWS (EC2, VPC, IAM, S3), Cloud Architecture Design, Cost Optimization |
...
| | |
|---|---|
| 🎯 **Solution Oriented** | I focus on outcomes, not just tasks |
| 🗣️ **Clear Communicator** | Technical concepts explained simply, no jargon overload |
...
I'm open to **Cloud / DevOps opportunities**, freelance infra work, and collaborating on open-source automation tooling. Feel free to reach out — I usually respond within a day.
